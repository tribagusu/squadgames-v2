...
import { gamesConfigData } from "../config/games.config";
          ...
          {gamesConfigData.map((game, i) => (
            ...
            >
              ...
              <div className="flex py-[2rem] px-10 text-darkPurple">
                <Link
                  href={game.link}
                  className="flex items-center gap-2 hover:translate-x-2 ease-in-out duration-300 py-2 px-2 hover:underline"
                >
