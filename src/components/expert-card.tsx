...
import { expertConfigData } from "../config/expert.config";
...
export default function ExpertCard() {
  return (
    <Swiper
      ...
      className="mySwiper"
    >
      {expertConfigData.map((expert, i) => (
        <SwiperSlide key={i} className="">
          <div className="bg-[#7D25F0] rounded-lg overflow-hidden mb-[2rem]">
            <div className=" border-[#8A40F5] rounded-xl">
              <Image
                src={expert.pic}
                alt="expert"
