  ...
  return (
    <div className="mt-10">
      <div className="container flex flex-col">
        <div className="flex flex-col md:flex-row gap-10">
          <div className="flex flex-col">
            ...
            <p className="mb-3">{article?.trainingDesc}</p>
          ...
          <Image
            ...
            width={article.image.fields.file.details.image.width}
            height={article.image.fields.file.details.image.height}
            alt="image"
        ...
        <div className="flex flex-col my-[3rem]">
          ...
          <div className="flex whitespace-nowrap overflow-auto w-full shadow-md">
            <div className="training-score">
              <span>{`${article.customerSatisfaction}/6`}</span>
              <p>Customer Satisfaction</p>
            </div>
            <div className="training-score">
              <span>{`${article.trainerSatisfaction}/6`}</span>
        ...
        <div className="flex flex-col md:flex-row gap-10 w-full md:my-10 items-start">
          ...
          <div className="sidebar-article ">
            <div>
              <h5>Training</h5>
              <p>{article.product_name.fields.name}</p>
            </div>
            <div>
              <h5>Games</h5>
      ...
      <div className="bg-baby py-10">
        <div className="container">{/* <OtherCaseStudy /> */}</div>
      </div>
    </div>
  );
};
